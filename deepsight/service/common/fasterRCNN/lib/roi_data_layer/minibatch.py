...
def _vis_img(roidb_unit):
  print(roidb_unit['image'])
  boxes = roidb_unit['boxes']
  pil_img = Image.fromarray(roidb_unit['im'][:,:,::-1])
  ...
  pil_img.save('/mnt/data/liuchang/cc/output/cell_det/test.jpg') 